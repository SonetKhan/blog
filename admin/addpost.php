            ...
            <div class="box round first grid">
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST')
                {
                    ...
                    $uploaded_image = "upload/".$unique_image;
                        ...
                        if($title == "" || $tags == "" || $author == "" || $cat == "" || $body == "" ||  $file_name == "")
                        {
                    ...
                    if ($inserted_rows) 
                    {
                     echo "<span style='color:red,font-size:18px;'>post insert successfully.</span>";
                    }
                    else
                    {
                         echo "<span style='color:red,font-size:18px;'>Post not insert.</span>";
                    }
                }
